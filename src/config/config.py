...
REQUEST_LOG_MAX_DAYS = get_env("REQUEST_LOG_MAX_DAYS", get_env("REQUEST_LOG_RETENTION_DAYS", 14))
REQUEST_LOG_MAX_FILES = get_env("REQUEST_LOG_MAX_FILES", get_env("REQUEST_LOG_MAX_COUNT", 1000))
REQUEST_LOG_MAX_BYTES = get_env("REQUEST_LOG_MAX_BYTES", get_env("REQUEST_LOG_MAX_SIZE", 100 * 1024 * 1024))
